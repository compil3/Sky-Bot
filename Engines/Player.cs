        ...
        public static Embed GetPlayer(string lookUpName, string seasonType, string seasonId)
        {
            ...
            try
            {
                ...
                foreach (var found in result)
                {
                    ...
                    if (found.System == "psn")
                        systemIcon =
                            "https://cdn.discordapp.com/attachments/689119430021873737/711030693743820800/220px-PlayStation_logo.svg.jpg";//"https://www.leaguegaming.com/images/league/icon/l73.png";
                    else if (found.System == "xbox") systemIcon =
                        "https://cdn.discordapp.com/attachments/689119430021873737/711030386775293962/120px-Xbox_one_logo.svg.jpg";//systemIcon = "https://www.leaguegaming.com/images/league/icon/l53.png";
