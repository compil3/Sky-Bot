...
namespace LGFA.Modules.Helpers
{
    public class CareerEmbeds
    {
        ...
        public static Embed CareerSeasonEmbed(string foundPlayerName, string foundPlayerUrl, string playerRecord, string playerAvgMatchRating, string playerGoals, string playerAssists, string playerShotsOnTarget, string playerShotAttempts, 
            string playerPassesCompleted, string playerPassesAttempted, string playerKeyPasses, string playerInterceptions, string playerTackles, string playerTackleAttempts, string playerPossW, string playerPossL, string playerBlocks, string playerRedCards, string playerYellowCards)
        {
            EmbedBuilder builder = null;
            Embed embed = null;
            var offense = "";
            ...
            builder = new EmbedBuilder()
                .WithTitle($"{foundPlayerName} - Career Statistics.")
                .WithUrl(foundPlayerUrl)
                .WithColor(new Color(0x26A20B))
                .WithCurrentTimestamp()
                .WithFooter(footer =>
